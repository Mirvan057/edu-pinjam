...
<body class="bg-light bg-registration">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 form-container">
                ...
                <form action="/regis" method="POST">
                    @csrf
                    <h2 class="mb-4" style="text-align: center">Registration</h2>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('noHp') is-invalid @enderror" name="noHp" id="noHp" aria-describedby="emailHelp">
                        @error('noHp')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
